...
export default function ScrollRevealText({ text, preview = false }: ScrollRevealTextProps) {
  ...
  return (
    <div 
      ref={containerRef} 
      className={`${styles.scrollRevealText} ${preview ? styles.preview : ''}`}
    >
      <div className={styles.text}>
        {words.map((word, index) => (
          <span
            ...
            style={{ opacity: wordOpacities[index] || 0.15 }}
          >
            {word}{' '}
          </span>
        ))}
